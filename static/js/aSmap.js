    ...
    map.loadImage('/static/Images/locations.png', function (error, image) {
        ...
        map.on('load', function () {
            ...
            map.on('click', function (e) {
                ...
                document.getElementById('IXPcountryName').textContent = SelectedCountry;
                let flagImg = document.querySelector(".flag");
                let flagImg2 = document.querySelector(".flag2");
                flagImg.src = `https://flagsapi.com/${SelectedCountry}/flat/64.png`;
                flagImg2.src = `https://flagsapi.com/${SelectedCountry}/flat/64.png`;
