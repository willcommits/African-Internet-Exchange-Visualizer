...
fetchCountryCoords(function (africanIXPdata) {
    ...
    console.log("Fetch Complete:", africanIXPdata)
    try {
 ...
 * adding a new source to the map object.**/
    function addLayersAndHandlers() {
        ...
        /**This  adds a new layer, 'inner-circle', to the map, which represents features from the 'africanIXPdata' source as circles. */
        map.addLayer({
            'id': 'inner-circle',
            'type': 'circle',
            'source': 'africanIXPdata',
